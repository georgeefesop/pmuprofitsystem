...
export function Sidebar({ onClose, currentModuleId }: SidebarProps) {
            ...
            <div className="mt-4 mb-2">
              ...
              <div className="bg-purple-700/50 p-3 rounded-lg mx-2 mb-2 border border-purple-600/30">
                <p className="text-white font-medium truncate text-sm flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-purple-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
