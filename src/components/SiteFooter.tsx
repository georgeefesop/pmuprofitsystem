          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-purple-600 hover:text-purple-700 hover:shadow-md transition-all"
                target="_blank"
