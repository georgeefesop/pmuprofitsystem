...
// Add this function to render a more user-friendly error message
function renderErrorMessage(error: string) {
  // Check if the error is related to environment mismatch
  if (error.includes('environment') && (error.includes('Local Development') || error.includes('Production'))) {
    return (
